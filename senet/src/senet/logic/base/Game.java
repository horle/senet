...
import senet.logic.exception.GameException;
import senet.logic.exception.InvalidInputException;
import senet.logic.exception.WinException;
import senet.logic.token_field.Field;
import senet.logic.token_field.GoalField;
import senet.logic.token_field.SenetQuery;
import senet.logic.token_field.SpecialField;
import senet.logic.token_field.Token;
import senet.logic.token_field.TokenOperations;
...
//			System.out.println("possible moves: " + possibleMoves);
	...
	public boolean initLang(String in){
		...
		messages = ResourceBundle.getBundle("senet.lang.lang", locale);
		return loc;
	}
